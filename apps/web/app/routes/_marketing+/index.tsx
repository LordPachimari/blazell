	...
	return (
		<main className="flex flex-col items-center">
			...
			<div
				...
				className="bg-component hover:bg-slate-3 shadow border border-border px-2 hover:bg-slate-2 cursor-pointer animate-fade-up text-sm font-medium text-slate-11 flex justify-center items-center p-1 gap-2 rounded-lg h-8 absolute top-[10vh]"
			>
