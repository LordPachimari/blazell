...
const ProductCard = ({ product }: { product: PublishedProduct }) => {
	return (
		<Link
			...
			prefetch="intent"
			className={cn(
				"group border min-h-20 min-w-20 hover:scale-[103%] col-span-1 row-span-1 hover:z-20 cursor-pointer border-border h-fit rounded-lg transition-all duration-200 ease-in-out",
				{
