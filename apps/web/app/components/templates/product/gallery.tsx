					...
					<CarouselContent className="shadow-none">
						...
						{images.length === 0 && (
							<CarouselItem className="aspect-square">
								<Card className="p-4 relative text-center shadow-none lg:shadow-md border-[0px] lg:border lg:border-mauve-5 dark:border-mauve-7   height-full cursor-pointer aspect-square">
