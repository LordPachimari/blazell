...
const toggleVariants = cva(
	"inline-flex items-center overflow-hidden border border-border   bg-component justify-center text-mauve-11 rounded-md font-medium ring-offset-background transition-colors hover:bg-muted hover:text-muted-foreground focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 data-[state=on]:bg-brand-2 data-[state=on]:border-brand-9 data-[state=on]:dark:border-brand-9 data-[state=on]:text-brand-9",
	{
		variants: {
			variant: {
