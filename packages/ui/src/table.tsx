...
>(({ className, ...props }, ref) => (
	<thead
		ref={ref}
		className={cn(
			"[&_tr]:border-b border-mauve-5 dark:border-mauve-7  ",
			className,
		)}
		{...props}
	/>
...
>(({ className, ...props }, ref) => (
	<tr
		ref={ref}
		className={cn(
			"border-b border-mauve-5 dark:border-mauve-7   transition-colors hover:bg-muted/50 data-[state=selected]:bg-mauve-a-2",
			className,
		)}
		{...props}
	/>
