...
function DialogContent({
	...
	return (
		<Drawer.Portal>
			...
			<Drawer.Content
				className={cn(
					"border-border fixed bottom-0 top-0 z-50 m-1 flex w-5/6 flex-col rounded-lg border bg-white dark:bg-slate-3 backdrop-blur-md after:hidden focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-ring focus-visible:ring-offset-1",
					className,
				)}
			>
				{children}
