...
const inputBaseStyles = cn(
	"bg-component hover:bg-mauve-a-1 shadow-sm border-mauve-7 shadow-buttons-neutral placeholder-mauve-9 text-ui-fg-base transition-fg relative w-full appearance-none rounded-lg border outline-none",
